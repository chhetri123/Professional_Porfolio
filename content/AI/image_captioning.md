...
This setup allowed us to generate captions that were not just simple sentences but coherent, context-rich paragra![alt text](image.png)phs, reflecting the intricacies of the Nepali language.
